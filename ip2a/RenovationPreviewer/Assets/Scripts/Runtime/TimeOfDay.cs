...
public static class TimeOfDay
{
    ...
    {
        new() { hour = 7,  elevation = 12f,  azimuth = -65f, sunColor = new(1f, 0.80f, 0.60f), sunIntensity = 0.7f, ambient = new(0.34f, 0.32f, 0.34f), skyExposure = 0.9f,  skyTint = new(0.60f, 0.45f, 0.40f) },
        new() { hour = 10, elevation = 40f,  azimuth = -35f, sunColor = new(1f, 0.96f, 0.90f), sunIntensity = 1.1f, ambient = new(0.56f, 0.57f, 0.60f), skyExposure = 1.2f,  skyTint = new(0.50f, 0.50f, 0.50f) },
        new() { hour = 13, elevation = 62f,  azimuth = 0f,   sunColor = new(1f, 0.98f, 0.95f), sunIntensity = 1.3f, ambient = new(0.64f, 0.64f, 0.66f), skyExposure = 1.3f,  skyTint = new(0.50f, 0.50f, 0.50f) },
        new() { hour = 16, elevation = 38f,  azimuth = 40f,  sunColor = new(1f, 0.92f, 0.80f), sunIntensity = 1.0f, ambient = new(0.54f, 0.52f, 0.52f), skyExposure = 1.1f,  skyTint = new(0.50f, 0.50f, 0.50f) },
        new() { hour = 19, elevation = 6f,   azimuth = 75f,  sunColor = new(1f, 0.55f, 0.30f), sunIntensity = 0.4f, ambient = new(0.26f, 0.20f, 0.22f), skyExposure = 0.6f,  skyTint = new(0.70f, 0.35f, 0.25f) },
